...
enum drive_method{NO_DRIVE, TANK, TANK_MECHANUM, ARCADE, ARCADE_MECHANUM, H_ARCADE};
...
class Drive
{
 public:
  ...
  void SetPID(float kp, float ki, float kd, float starti, float settle_error, float settle_time, float timeout, float min_velocity);
  void SetTurnPID(float kp, float ki, float kd, float starti, float settle_error, float settle_time, float timeout, float min_velocity);
