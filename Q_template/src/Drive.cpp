...
Drive::Drive(int L_port, int R_port, gyro Gyro, float wheel_size) : L(L_port, false), R(R_port, true), Gyro(Gyro), wheel_ratio(wheel_size/360*2) {
...
int Drive::DriveFor(float distance){
  ...
  PID drivePID(drive_kp,drive_ki,drive_kd,drive_starti,drive_settle_error,drive_settle_time,drive_timeout, drive_min_velocity);
  PID turnPID(turn_kp,turn_ki,turn_kd,turn_starti,turn_settle_error,turn_settle_time,turn_timeout, drive_min_velocity);
...
int Drive::TurnTo(float angle){
 ...
 //Declare Turn Object
 PID TurnPID(turn_kp,turn_ki,turn_kd,turn_starti,turn_settle_error,turn_settle_time,turn_timeout,turn_min_velocity);
